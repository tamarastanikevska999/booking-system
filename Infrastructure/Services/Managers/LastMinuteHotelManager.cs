...
{
    public class LastMinuteHotelManager : HotelManager
    {
        public LastMinuteHotelManager(IHotelService hotelService, MemoryStorageService memoryStorageService, BookingMappers bookingMappers)
